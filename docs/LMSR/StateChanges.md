...
\[
\qquad
    S \;\equiv\; \sum_{i\in \text{listed}} R_i + R_{\text{reserve}}
\]
...
\[
\chi_G \;\equiv\; e^{\Delta U_{\text{rest}}/b},
\qquad
\chi_{R_k} \;\equiv\; e^{(\Delta U_k - \Delta U_{\text{rest}})/b}.
\]

where

- \( \Delta U_k \) (affects the traded slot \(k\))

- \( \Delta U_{\text{rest}} \) (affects “everything else”)
...
- **Buy Back(k)**:  
  \( \chi_G = 1,\quad \chi_{R_k} = e^{+t/b}. \)
- **Sell Back(k)**:  
  \( \chi_G = 1,\quad \chi_{R_k} = e^{-t/b}. \)
- **Buy Lay(k)**:  
  \( \chi_G = e^{+t/b},\quad \chi_{R_k} = e^{-t/b}. \)
- **Sell Lay(k)**:  
  \( \chi_G = e^{-t/b},\quad \chi_{R_k} = e^{+t/b}. \)
