...
Start here: [What Is It][what-is-it]· [Technical Overview][technical-overview]
...
Read: [What Is It][what-is-it] · [Zero-Sum][leger-zero-sum]
...
- Details: [AMM (LMSR as O(1))][pp-lmsr-whitepaper]  
- Contract surface: [AMM.sol][LMSRMarketMaker.sol]
...
- Concepts & math: [Zero-Sum][ledger-zero-sum]
...
- Overview: [Synthetic Liquidity][synthetic-liquidity-overview] 
- Algorithms: [Synthetic Accounting][synthetic-liquidity-accounting] · [Principles][synthetic-liquidity-principles]
...
- Concepts: [Solvency][solvency-overview] · [Solvency Accounting][solvency-accounting]  
- Data structure: [Heap Logic][heap-logic]
...
1. **Market instantiation** 
   ...
   - Links: [MarketIntialisation][market-initialisation] · [Synthetic Liquidity][synthetic-liquidity-overview]
...
2. **Trade (BACK or LAY) against LMSR**  
   ...
   - Links: [AMM][pp-lmsr-whitepaper]· [Ledger Accounting][standard-ledger-accounting]
...
3. **Issue / Redeem**  
   ...
   - Links: [Zero-Sum][ledger-zero-sum]

4. **Liquidity growth**  
   - As real USDC arrives, it **replaces ISC** and then increases depth; prices remain consistent.  
   - Links: [Synthetic Accounting][synthetic-liquidity-accounting]
...
Start from: [Contracts Index][contracts-index] · [Technical Overview][technical-overview]
...
- Planned artifacts: specs & audits.  
  - See: [Documents Needed][documents-needed]
...
Dive deeper:
- [What Is It][what-is-it] · [Technical Overview][technical-overview] 
- [AMM (LMSR O(1))][pp-lmsr-whitepaper] · [Zero-Sum][ledger-zero-sum]  
- [Solvency][solvency-overview] · [Solvency Accounting][solvency-accounting]
- [Synthetic Liquidity][synthetic-liquidity-overview]  
- [Ledger Overview][ledger-overview] · [Ledger Accounting][standard-ledger-accounting]  
