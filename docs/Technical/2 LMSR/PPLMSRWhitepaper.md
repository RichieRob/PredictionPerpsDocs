...
For the full implementation of the code of the LSMR AMM in Prediction Perps see [**LMSRMarketMaker.sol**][LMSRMarketMaker.sol]

For discussion on the internal ledger accounting which supports the implentation of the AMM start with [**Ledger Overview**][ledger-overview]
