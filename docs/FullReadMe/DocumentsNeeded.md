...
3) Commentary for each contract

4) Discussion about each external function (like uniswap has)

5) Consolidated Invariants & Safety/Threat Model

6) Testing plan/spec/outline
